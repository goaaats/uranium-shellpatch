...
read -p "Disabling IPv6 could improve patching speed. Do you want to disable IPv6? [y/n]: " ipv6yesno
if [["$ipv6yesno" == "y" || "$ipv6yesno" == "yes" || "$ipv6yesno" == "Y" || "$ipv6yesno" == "Yes" || "$ipv6yesno" == "YES"]]; then
